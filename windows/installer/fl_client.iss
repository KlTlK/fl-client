...
[Files]
Source: "{#SourcePath}build\windows\x64\runner\Release\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs
Source: "{#SourcePath}libs\windows\sing-box.exe"; DestDir: "{app}"; Flags: ignoreversion
