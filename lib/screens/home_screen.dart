          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 30),
                const TrafficChart(state: vpn), // note: rebuild via Consumer
                ...
                GridView.count(
                  ...
                  children: [
                    ...
                    StatCard(
                      label: 'Download',
                      value: '${vpn.downSpeed.toStringAsFixed(0)} KB/s',
                      icon: Icons.arrow_downward_rounded,
                      color: AppTheme.neonAlt,
                    ),
                    StatCard(
                      label: 'Upload',
                      value: '${vpn.upSpeed.toStringAsFixed(0)} KB/s',
                ...
                FilledButton.icon(
                  ...
                  label: const Text('Import config (VLESS / VMess)'),
