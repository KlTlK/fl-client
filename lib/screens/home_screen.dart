...
class _HomeScreenState extends State<HomeScreen> {
      ...
      return Scaffold(
        ...
        body: SafeArea(
          child: Column(children: [
            _topBar(vpn),
            Expanded(child: _centerArea(vpn, connected, node)),
            _bottomArea(context, vpn),
          ]),
        ),
      );
    });
  ...
  Widget _topBar(VpnState vpn) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 12),
      child: Row(children: [
        const Icon(Icons.auto_awesome_rounded, color: AppTheme.accentSoft, size: 24),
        ...
        _iconBtn(Icons.view_list_rounded, () => _showServers(context, vpn)),
        const SizedBox(width: 10),
  ...
  Widget _centerArea(VpnState vpn, bool connected, dynamic node) {
  ...
  Widget _bottomArea(BuildContext context, VpnState vpn) {
    return Padding(
      ...
      child: Column(children: [
        ...
        Row(children: [
          ...
          FilledButton(
            ...
            style: FilledButton.styleFrom(
              minimumSize: const Size(70, 44), padding: EdgeInsets.zero,
          ...
          OutlinedButton(
            ...
            child: const Icon(Icons.content_paste_rounded, size: 16),
          ),
        ]),
        ...
        SizedBox(
          ...
          child: FilledButton.icon(
            ...
            label: Text(
              vpn.allNodes.isEmpty ? 'Нет серверов' : 'Все серверы (${vpn.allNodes.length})',
  ...
  void _showServers(BuildContext context, VpnState vpn) {
    showModalBottomSheet(
      ...
      builder: (ctx) => DraggableScrollableSheet(
        ...
        builder: (ctx2, sc) => Consumer<VpnState>(builder: (_, vpn2, __) {
          return Column(children: [
            Container(width: 40, height: 4, margin: const EdgeInsets.only(top: 12),
                decoration: BoxDecoration(color: AppTheme.card, borderRadius: BorderRadius.circular(2))),
            Padding(
              ...
              child: Row(children: [
                ...
                ChoiceChip(
                  ...
                  selected: vpn2.pingMethod == PingMethod.tcp,
                  onSelected: (_) => vpn2.setPingMethod(PingMethod.tcp),
                  visualDensity: VisualDensity.compact,
                ),
                const SizedBox(width: 4),
                ChoiceChip(
                  label: const Text('HTTP', style: TextStyle(fontSize: 11)),
                  selected: vpn2.pingMethod == PingMethod.httpGet,
                  onSelected: (_) => vpn2.setPingMethod(PingMethod.httpGet),
                  visualDensity: VisualDensity.compact,
                ),
                const SizedBox(width: 6),
                OutlinedButton(
                  onPressed: vpn2.allNodes.isEmpty ? null : () => vpn2.pingAll(),
                  style: OutlinedButton.styleFrom(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (_, si) {
                    ...
                    return Container(
                      ...
                      child: Column(children: [
                        InkWell(
                          onTap: () => vpn2.toggleSubscription(si),
                          ...
                          child: Padding(
                            ...
                            child: Row(children: [
                              ...
                              GestureDetector(
                                onTap: () => vpn2.removeSubscription(si),
                                child: Container(
                                  width: 32, height: 32,
                            ...
                            return GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: sel ? Border.all(color: AppTheme.accent.withOpacity(0.3)) : null,
                                ),
                                child: Row(children: [
          ...
          Container(
            ...
            child: Column(children: [
              ListTile(
                ...
                leading: const Icon(Icons.speed_rounded, color: AppTheme.accentSoft),
              ...
              ListTile(
                contentPadding: const EdgeInsets.symmetric(horizontal: 16),
                leading: const Icon(Icons.memory_rounded, color: AppTheme.accentSoft),
                title: const Text('Ядро', style: TextStyle(color: AppTheme.textPrimary)),
                subtitle: Text(
                  vpn.coreAvailable ? 'sing-box (process)' : 'Недоступно',
